...
export default {
  ...
  setup(props) {
      ...
      // const currentTurn = ref({ username: null });
      ...
      const handlePlayerOneAlgorithm = async () => {
          ...
          if (currentRound.playerOneCard === null) {
              ...
              if (currentRound.playerTwoCard === null) {
                  ...
                  // currentTurn = battleDetails.value.playerOne.username;
              } else {
              ...
              // currentTurn = battleDetails.value.playerTwo.username;
          }
      };

      // const navigateToBattleHistory = () => {
      //   const router = useRouter();
      //   router.push({
      //     name: '/battle-hist', // Your route name
      //     params: { currentTurn: currentTurn } // Passing current turn as a route parameter
      //   });
      // };
